...
> 📢 **Offizieller Telegram-Kanal**: Abonnieren Sie den [Offiziellen GPDb Telegram-Kanal (https://t.me/gpdbnews)](https://t.me/gpdbnews) für die neuesten Release-Updates, Datenbank-News und Anwendungstipps!
...
│      GPDb.db (SQLite 3 WAL-Modus) + image_cache/ (Lokal)    │
└─────────────────────────────────────────────────────────────┘
```
